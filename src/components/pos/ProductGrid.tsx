...
export const ProductGrid: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-100/80 p-3 overflow-hidden border-r border-slate-200">
      {/* Top Filter Bar: Search + Dietary Badges */}
      ...
      {/* Category Pills (Square Color Coding) */}
      <div className="flex items-center space-x-1.5 overflow-x-auto pb-2 mb-2">
        <button
          ...
          className={`px-3.5 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition whitespace-nowrap border ${
      ...
      {/* Realistic Touch Register Product Grid */}
